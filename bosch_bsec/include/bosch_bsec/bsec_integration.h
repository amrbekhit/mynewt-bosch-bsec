...
#include "bosch_bsec/bsec_interface.h"
#include "bosch_bsec/bsec_datatypes.h"
 ...
 */
int bsec_iot_init(float sample_rate, float temperature_offset, struct sensor *bme680, 
